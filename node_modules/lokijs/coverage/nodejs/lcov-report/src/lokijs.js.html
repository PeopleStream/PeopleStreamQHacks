  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>1718/2391</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">65.98% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>871/1320</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">65.57% </span>
        <span class="quiet">Functions</span>
        <span class='fraction'>219/334</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">72.09% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>1710/2372</span>
      </div>
    </div>
  </div>
...
6114
6115
6116</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    function compoundeval(properties, obj1, obj2) {</span>
<span class="cstat-no" title="statement not covered" >      var res = 0;</span>
<span class="cstat-no" title="statement not covered" >      var prop, field;</span>
...
<span class="cstat-no" title="statement not covered" >        field = prop[0];</span>
<span class="cstat-no" title="statement not covered" >        res = sortHelper(obj1[field], obj2[field], prop[1]);</span>
...
&nbsp;
      $dteq: <span class="fstat-no" title="function not covered" >function (a, b) {</span>
<span class="cstat-no" title="statement not covered" >        if (ltHelper(a, b, false)) {</span>
<span class="cstat-no" title="statement not covered" >          return false;</span>
        }
<span class="cstat-no" title="statement not covered" >        return !gtHelper(a, b, false);</span>
      },
&nbsp;
      $gt: function (a, b) {
...
&nbsp;
      $type: <span class="fstat-no" title="function not covered" >function (a, b) {</span>
...
<span class="cstat-no" title="statement not covered" >            type = 'array';</span>
          } else <span class="cstat-no" title="statement not covered" >if (a instanceof Date) {</span>
<span class="cstat-no" title="statement not covered" >            type = 'date';</span>
          }
        }
<span class="cstat-no" title="statement not covered" >        return (typeof b !== 'object') ? (type === b) : doQueryOp(type, b);</span>
      },
&nbsp;
      $size: function (a, b) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function cloneObjectArray(objarray, method) {</span>
<span class="cstat-no" title="statement not covered" >      var i,</span>
        result = [];
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (method == "parse-stringify") {</span>
<span class="cstat-no" title="statement not covered" >        return clone(objarray, method);</span>
      }
&nbsp;
...
&nbsp;
    ...
    LokiEventEmitter.prototype.removeListener = function (eventName, listener) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(eventName)) {
<span class="cstat-no" title="statement not covered" >        eventName.forEach(<span class="fstat-no" title="function not covered" >function(currentEventName) {</span></span>
<span class="cstat-no" title="statement not covered" >          self.removeListener(currentEventName, listen);</span>
        });
      }
&nbsp;
...
&nbsp;
     ...
     * @memberof Loki
     */
    Loki.prototype.deleteDatabase = <span class="fstat-no" title="function not covered" >function (options, callback) {</span>
...
<span class="cstat-no" title="statement not covered" >        this.persistenceAdapter.deleteDatabase(this.filename, <span class="fstat-no" title="function not covered" >function deleteDatabaseCallback(err) {</span></span>
<span class="cstat-no" title="statement not covered" >          cFun(err);</span>
        });
      } else {
<span class="cstat-no" title="statement not covered" >        cFun(new Error('persistenceAdapter not configured'));</span>
...
&nbsp;
     ...
     */
    Resultset.prototype.reset = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >      if (this.filteredrows.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >        this.filteredrows = [];</span>
      }
<span class="cstat-no" title="statement not covered" >      this.filterInitialized = false;</span>
...
<span class="cstat-no" title="statement not covered" >      var wrappedComparer =</span>
        (<span class="fstat-no" title="function not covered" >function (userComparer, data) {</span>
...
<span class="cstat-no" title="statement not covered" >            return userComparer(data[a], data[b]);</span>
          };
...
&nbsp;
      var prop;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (properties.length === 1) {
        prop = properties[0];
...
<span class="cstat-no" title="statement not covered" >      for (var i = 0, len = properties.length; i &lt; len; i += 1) {</span>
<span class="cstat-no" title="statement not covered" >        prop = properties[i];</span>
<span class="cstat-no" title="statement not covered" >        if (!Array.isArray(prop)) {</span>
<span class="cstat-no" title="statement not covered" >          properties[i] = [prop, false];</span>
        }
      }
&nbsp;
      // if this is chained resultset with no filters applied, just we need to populate filteredrows first
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var wrappedComparer =</span>
        (<span class="fstat-no" title="function not covered" >function (props, data) {</span>
<span class="cstat-no" title="statement not covered" >          return <span class="fstat-no" title="function not covered" >function (a, b) {</span></span>
<span class="cstat-no" title="statement not covered" >            return compoundeval(props, data[a], data[b]);</span>
          };
...
<span class="cstat-no" title="statement not covered" >            for (i = 0, len = segm.length; i &lt; len; i++) {</span>
<span class="cstat-no" title="statement not covered" >              result.push(index.values[segm[i]]);</span>
            }
          }
        }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        method = options.forceCloneMethod || this.collection.cloneMethod;</span>
<span class="cstat-no" title="statement not covered" >        for (i = 0; i &lt; len; i++) {</span>
<span class="cstat-no" title="statement not covered" >          result.push(clone(data[fr[i]], method));</span>
        }
      } else {
        for (i = 0; i &lt; len; i++) {
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.options.hasOwnProperty('minRebuildInterval')) {
...
&nbsp;
     ...
     * @memberof DynamicView
     */
    DynamicView.prototype.removeFilters = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >      this.rebuildPending = false;</span>
...
&nbsp;
     ...
     * @memberof DynamicView
     */
    DynamicView.prototype.count = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >      if (this.options.persistent) {</span>
<span class="cstat-no" title="statement not covered" >        return this.resultdata.length;</span>
      }
<span class="cstat-no" title="statement not covered" >      return this.resultset.count();</span>
    };
&nbsp;
    /**
...
&nbsp;
      var self = this;
      setTimeout(function () {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (self.rebuildPending) {
...
&nbsp;
    ...
    DynamicView.prototype.performSortPhase = function (options) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.sortDirty &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!this.resultsdirty)</span> {
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
      options = options || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.sortDirty) {
...
&nbsp;
        var changedObjects = typeof Set === 'function' ? new Set() : <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!changedObjects.add)
...
&nbsp;
        changedObjects.forEach(function (object) {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (!hasOwnProperty.call(object, '$loki'))
...
&nbsp;
      if (this.binaryIndices[property] &amp;&amp; !force) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.binaryIndices[property].dirty) <span class="cstat-no" title="statement not covered" >return;</span>
      }
&nbsp;
      var index = {
        'name': property,
...
&nbsp;
      ...
      var obj = this.cloneObjects ? <span class="branch-0 cbranch-no" title="branch not covered" >clone(doc, this.cloneMethod) </span>: doc;
&nbsp;
...
&nbsp;
      ...
      returnObj = this.cloneObjects ? <span class="branch-0 cbranch-no" title="branch not covered" >clone(obj, this.cloneMethod) </span>: obj;
&nbsp;
...
&nbsp;
        // if configured to clone, do so now... otherwise just use same obj reference
        newInternal = this.cloneObjects ? <span class="branch-0 cbranch-no" title="branch not covered" >clone(doc, this.cloneMethod) </span>: doc;
&nbsp;
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (newInternal !== doc) {
<span class="cstat-no" title="statement not covered" >          this.addAutoUpdateObserver(doc);</span>
        }
&nbsp;
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.adaptiveBinaryIndices) {
          ...
          for (key in bIndices) {
<span class="cstat-no" title="statement not covered" >            this.adaptiveBinaryIndexUpdate(position, key);</span>
          }
        }
        else {
...
&nbsp;
        ...
        this.dirty = true; // for autosave scenarios
&nbsp;
        this.emit('update', doc, this.cloneObjects ? <span class="branch-0 cbranch-no" title="branch not covered" >clone(oldInternal, this.cloneMethod) </span>: null);
        return doc;
      } catch (err) {
        this.rollback();
...
&nbsp;
        ...
        this.dirty = true; // for autosave scenarios
&nbsp;
        return (this.cloneObjects) ? (<span class="branch-0 cbranch-no" title="branch not covered" >clone(obj, this.cloneMethod))</span> : (obj);
      } catch (err) {
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.adaptiveBinaryIndices) {
          ...
          var key, bIndices = this.binaryIndices;
          for (key in bIndices) {
<span class="cstat-no" title="statement not covered" >            this.adaptiveBinaryIndexRemove(position, key);</span>
          }
        }
        else {
<span class="cstat-no" title="statement not covered" >          this.flagBinaryIndexesDirty();</span>
...
&nbsp;
     ...
     */
    Collection.prototype.getBinaryIndexPosition = <span class="fstat-no" title="function not covered" >function(dataPosition, binaryIndexName) {</span>
<span class="cstat-no" title="statement not covered" >      var val = this.data[dataPosition][binaryIndexName];</span>
<span class="cstat-no" title="statement not covered" >      var index = this.binaryIndices[binaryIndexName].values;</span>
&nbsp;
      // i think calculateRange can probably be moved to collection
      // as it doesn't seem to need resultset.  need to verify
      //var rs = new Resultset(this, null, null);
<span class="cstat-no" title="statement not covered" >      var range = this.calculateRange("$eq", binaryIndexName, val);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (range[0] === 0 &amp;&amp; range[1] === -1) {</span>
...
<span class="cstat-no" title="statement not covered" >      for(var idx = min; idx &lt;= max; idx++) {</span>
<span class="cstat-no" title="statement not covered" >        if (index[idx] === dataPosition) <span class="cstat-no" title="statement not covered" >return idx;</span></span>
      }
&nbsp;
      // uhoh
<span class="cstat-no" title="statement not covered" >      return null;</span>
...
&nbsp;
     ...
     * @param {string} binaryIndexName : index to search for dataPosition in
     */
    Collection.prototype.adaptiveBinaryIndexUpdate = <span class="fstat-no" title="function not covered" >function(dataPosition, binaryIndexName) {</span>
      // linear scan needed to find old position within index unless we optimize for clone scenarios later
      // within (my) node 5.6.0, the following for() loop with strict compare is -much- faster than indexOf()
<span class="cstat-no" title="statement not covered" >      var idxPos,</span>
        index = this.binaryIndices[binaryIndexName].values,
        len=index.length;
&nbsp;
<span class="cstat-no" title="statement not covered" >      for(idxPos=0; idxPos &lt; len; idxPos++) {</span>
<span class="cstat-no" title="statement not covered" >        if (index[idxPos] === dataPosition) <span class="cstat-no" title="statement not covered" >break;</span></span>
      }
&nbsp;
      //var idxPos = this.binaryIndices[binaryIndexName].values.indexOf(dataPosition);
<span class="cstat-no" title="statement not covered" >      this.binaryIndices[binaryIndexName].values.splice(idxPos, 1);</span>
&nbsp;
      //this.adaptiveBinaryIndexRemove(dataPosition, binaryIndexName, true);
<span class="cstat-no" title="statement not covered" >      this.adaptiveBinaryIndexInsert(dataPosition, binaryIndexName);</span>
    };
&nbsp;
    /**
     ...
     * @param {string} binaryIndexName : index to search for dataPosition in
     */
    Collection.prototype.adaptiveBinaryIndexRemove = <span class="fstat-no" title="function not covered" >function(dataPosition, binaryIndexName, removedFromIndexOnly) {</span>
<span class="cstat-no" title="statement not covered" >      var idxPos = this.getBinaryIndexPosition(dataPosition, binaryIndexName);</span>
<span class="cstat-no" title="statement not covered" >      var index = this.binaryIndices[binaryIndexName].values;</span>
<span class="cstat-no" title="statement not covered" >      var len,</span>
        idx;
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (idxPos === null) {</span>
...
<span class="cstat-no" title="statement not covered" >      if (removedFromIndexOnly === true) {</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
      // since index stores data array positions, if we remove a document
      // we need to adjust array positions -1 for all document positions greater than removed position
<span class="cstat-no" title="statement not covered" >      len = index.length;</span>
<span class="cstat-no" title="statement not covered" >      for (idx = 0; idx &lt; len; idx++) {</span>
<span class="cstat-no" title="statement not covered" >        if (index[idx] &gt; dataPosition) {</span>
<span class="cstat-no" title="statement not covered" >          index[idx]--;</span>
        }
      }
    };
&nbsp;
...
<span class="branch-8 cbranch-no" title="branch not covered" >      case '$in':</span>
<span class="cstat-no" title="statement not covered" >        var idxset = [],</span>
          segResult = [];
        // query each value '$eq' operator and merge the seqment results.
<span class="cstat-no" title="statement not covered" >        for (var j = 0, len = val.length; j &lt; len; j++) {</span>
<span class="cstat-no" title="statement not covered" >            var seg = this.calculateRange('$eq', prop, val[j]);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            for (var i = seg[0]; i &lt;= seg[1]; i++) {</span>
<span class="cstat-no" title="statement not covered" >                if (idxset[i] === undefined) {</span>
<span class="cstat-no" title="statement not covered" >                    idxset[i] = true;</span>
<span class="cstat-no" title="statement not covered" >                    segResult.push(i);</span>
                }
            }
        }
<span class="cstat-no" title="statement not covered" >        return segResult;</span>
      }
&nbsp;
      // hone in on start position of value
      while (min &lt; max) {
...
&nbsp;
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.cloneObjects) {
        return result;
      } else {
<span class="cstat-no" title="statement not covered" >        return clone(result, this.cloneMethod);</span>
      }
    };
&nbsp;
    /**
...
<span class="cstat-no" title="statement not covered" >        return cloneObjectArray(results, this.cloneMethod);</span>
      }
    };
&nbsp;
    /**
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed Dec 21 2016 15:45:24 GMT+0000 (GMT)
</div>
</div>
