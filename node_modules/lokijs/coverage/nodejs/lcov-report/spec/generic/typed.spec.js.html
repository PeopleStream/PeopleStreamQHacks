...
<html lang="en">
<head>
    <title>Code coverage report for spec/generic/typed.spec.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">spec/generic/</a> typed.spec.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >        console.log('Name: ' + this.name);</span>
      };
    }
&nbsp;
    var json = {
