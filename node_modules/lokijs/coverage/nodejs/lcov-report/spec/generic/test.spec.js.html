...
<html lang="en">
<head>
    <title>Code coverage report for spec/generic/test.spec.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">spec/generic/</a> test.spec.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">90.46% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>370/409</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>369/407</span>
      </div>
    </div>
  </div>
...
1243
1244
1245</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js"><span class="missing-if-branch" title="else path not taken" >E</span>if (typeof (window) === 'undefined') {
...
&nbsp;
  function docCompare(a, b) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (a.$loki &lt; b.$loki) <span class="cstat-no" title="statement not covered" >return -1;</span>
    <span class="missing-if-branch" title="else path not taken" >E</span>if (a.$loki &gt; b.$loki) return 1;
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        wasAdded = false;</span>
      }
&nbsp;
      expect(wasAdded).toEqual(true);
&nbsp;
      // remove object so later queries access valid properties on all objects
      <span class="missing-if-branch" title="else path not taken" >E</span>if (wasAdded) {
...
&nbsp;
      ...
      it('return type', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        expect(typeof eic.findOne({</span>
          'testid': 1
        })).toEqual('object');
      });
&nbsp;
      // coll.findOne return match
      it('should match 7.2', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        expect(eic.findOne({</span>
          'testid': 5
...
&nbsp;
      // findOne with $and op
      it('findOne with $and op', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        expect(eic.findOne({</span>
          '$and': [{
            'testid': 1
          }, {
...
&nbsp;
      it('findOne with $or op', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        expect(eic.findOne({</span>
          '$or': [{
            'testid': 2
          }, {
...
&nbsp;
      ...
      jonas.age = 23;
      users.update(jonas);
      it('evaluate documents', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        expect(view.data().length).toEqual(users.data.length - 1);</span>
<span class="cstat-no" title="statement not covered" >        jonas.age = 30;</span>
<span class="cstat-no" title="statement not covered" >        users.update(jonas);</span>
<span class="cstat-no" title="statement not covered" >        expect(view.data().length).toEqual(users.data.length);</span>
<span class="cstat-no" title="statement not covered" >        jonas.age = 23;</span>
<span class="cstat-no" title="statement not covered" >        users.update(jonas);</span>
<span class="cstat-no" title="statement not covered" >        expect(view.data().length).toEqual(users.data.length - 1);</span>
<span class="cstat-no" title="statement not covered" >        jonas.age = 30;</span>
<span class="cstat-no" title="statement not covered" >        users.update(jonas);</span>
...
&nbsp;
      it('Result data Equality', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        expect(result1).toEqual(result2);</span>
      });
&nbsp;
      it('Strict Equality', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        expect(users.find(query) === view.data()).toBeTruthy();</span>
      });
&nbsp;
      it('View data equality', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        expect(view.resultset).toEqual(view.resultset.copy());</span>
      });
&nbsp;
      it('View data copy strict equality', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        expect(view.resultset === view.resultset.copy()).toBeFalsy();</span>
      });
&nbsp;
&nbsp;
      return view;
...
&nbsp;
      ...
      it('dynamic view initialization 1', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        expect(pview.resultset.filteredrows.length).toEqual(3);</span>
      })
      it('dynamic view initialization 2', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        expect(pview.resultdata.length).toEqual(0);</span>
      });
&nbsp;
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          expect(pviewResultsetLenBefore + 1).toEqual(pviewResultsetLenAfter);</span>
        });
&nbsp;
&nbsp;
...
&nbsp;
      ...
      for (var idxFR = 0; idxFR &lt; frcopy2.length; idxFR++) {
        it('dynamic view resultset/resultdata consistency', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >          expect(pview.resultdata[idxFR]).toEqual(pview.collection.data[frcopy2[idxFR]]);</span>
        });
      }
      // now verify they are not exactly equal (verify sort moved stuff)
      it('dynamic view sort', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        expect(frcopy).toEqual(frcopy2)</span>
      });
    });
  });
&nbsp;
...
&nbsp;
      ...
      it('one result exists', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        expect(results.length).toEqual(1);</span>
      });
      it('the correct result is returned', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        expect(results[0].a).toEqual(1);</span>
      });
&nbsp;
&nbsp;
      item.a = 2;
...
<span class="cstat-no" title="statement not covered" >        expect(results.length).toEqual(1);</span>
      ...
      it('the correct result is returned', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        expect(results[0].a).toEqual(2);</span>
      });
    });
  });
&nbsp;
...
&nbsp;
      ...
      it('no results found', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        expect(resultsWithIndex.length).toEqual(0);</span>
      });
    });
  });
&nbsp;
  describe('stepDynamicViewPersistence', function () {
    it('works', function testAnonym() {
      ...
      it('Anonym collection', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        expect(coll.data.length).toEqual(2);</span>
      });
      it('Collection not found', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        expect(db.getCollection('anonym')).toEqual(null);</span>
      });
      coll.name = 'anonym';
      db.loadCollection(coll);
      it('Anonym collection loaded', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        expect(!!db.getCollection('anonym') === true).toBeTruthy();</span>
      });
      coll.clear();
      it('No data after coll.clear()', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        expect(0).toEqual(coll.data.length)</span>
      });
    });
  });
&nbsp;
  describe('stepDynamicViewPersistence', function () {
    it('works', function testCollections() {
      ...
      it('DB name', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        expect(db.getName()).toEqual('testCollections');</span>
      });
      ...
      it('List collections', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        expect(db.listCollections().length).toEqual(2);</span>
      });
      t.clear();
      var users = [{
        name: 'joe'
      ...
      t.insert(users);
&nbsp;
      it('2 docs after array insert', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        expect(2).toEqual(t.data.length)</span>
      });
      t.remove(users);
      it('0 docs after array remove', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        expect(0).toEqual(t.data.length)</span>
      });
&nbsp;
      function TestError() {}
